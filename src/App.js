        ...
        <tr key={index} style={{ textAlign: 'center' }}>
          ...
          <td>
            <button
             ...
             <button className="btn btn-info m-1"onClick={() => this.Update(users, index)}>
              Update
            </button>

            <button className="btn btn-info m-1"onClick={() => this.Details(users)}>
              Details
            </button>
          </td>
        </tr>
            ...
            <div className="container">
              <div className="text-center">
                <div
                  ...
                  <div
                    className="col-md-4"
                    style={{border: 'solid 2px',borderRadius: '100px',width: '150px',}}>
