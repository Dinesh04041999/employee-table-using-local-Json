  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <form method="post" name="userRegistrationForm" onSubmit={(e) => this.submituserRegistrationForm(e)}>
          <div className="container-1" id="form">
            <div className="row mt-5" style={{ height: "50px", padding: "5px", marginTop: "35px" }}>
              ...
              <div className="col-md-4">
                <input type="text" name="id" autoComplete="off" disabled={this.props.data?true:false}
                  defaultValue={
                    this.props.data ? 
                    this.props.data.id :
              ...
              <div className="col-md-4"
                ...
                <div className="short-div"
                  style={{ backgroundColor: "white", position: "relative", height: "300px", width: "300px", zIndex: "1" }}>
                  <img src={this.state.fields.file} alt="" className="card-img-top"  style={{ height: "300px",width:"373px" }} />
                </div>
              </div>
          ...
          <div className="row"
            ...
            <div className="col-md-4">
              <input type="text" name="employeename" minLength="4" maxLength="24" autoComplete="off"
                defaultValue={
          ...
          <div className="row"
            ...
            <div className="col-md-4">
              <input type="number" name="employeesalary" style={{ marginTop: '10px' }} autoComplete="off"
                defaultValue={
                  this.props.data
          ...
          <div className="row"
            ...
            <div className="col-md-4">
              <input type="number" name="employeeage" autoComplete="off"
                defaultValue={
                  this.props.data
          ...
          <div className="row"
            ...
            <div className="col-md-4">
              <input type="text" name="designation" minLength="2" maxLength="24" autoComplete="off"
                defaultValue={
                  this.props.data
